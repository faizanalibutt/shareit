...
public class TinyDB {
    ...
    /**
     * Get parsed ArrayList of Char from SharedPreferences at 'key'
     *
     * @param key SharedPreferences key
     * @return ArrayList of Char
     */
    public ArrayList<CharSequence> getListChar(String key) {
    ...
    public ArrayList<Uri> getListObjectUri(String key, Class<?> mClass) {
        Gson gson = new Gson();
        ...
        for (String jObjString : objStrings) {
            Uri value = (Uri) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
...
//    }
    ...
    public void putListChar(String key, ArrayList<CharSequence> stringList) {
        checkForNullKey(key);
...
//    }
//
    public void putListObjectURI(String key, ArrayList<Uri> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<>();
        for (Uri obj : objArray) {
