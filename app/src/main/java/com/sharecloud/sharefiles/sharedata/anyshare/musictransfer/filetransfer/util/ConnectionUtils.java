...
public class ConnectionUtils {
    ...
    private com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.HotspotUtils mHotspotUtils;
    ...
    private ConnectionUtils(Context context) {
        ...
        if (mContext != null) {
            ...
            mHotspotUtils = com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.HotspotUtils.getInstance(mContext);
        ...
        while (true) {
            ...
            if (!getWifiManager().isWifiEnabled()) {
                ...
                if (routeInfo != null && routeInfo.gateway != 0 && routeInfo.dns2 == 0) {
                    final String testedRemoteAddress = com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NetworkUtils.convertInet4Address(routeInfo.gateway);

                    Log.d(TAG, String.format("establishHotspotConnection(): DhcpInfo: gateway: %s dns1: %s dns2: %s ipAddr: %s serverAddr: %s netMask: %s",
                            testedRemoteAddress,
                            com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NetworkUtils.convertInet4Address(routeInfo.dns1),
                            com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NetworkUtils.convertInet4Address(routeInfo.dns2),
                            com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NetworkUtils.convertInet4Address(routeInfo.ipAddress),
                            com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NetworkUtils.convertInet4Address(routeInfo.serverAddress),
                            com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NetworkUtils.convertInet4Address(routeInfo.netmask)));
