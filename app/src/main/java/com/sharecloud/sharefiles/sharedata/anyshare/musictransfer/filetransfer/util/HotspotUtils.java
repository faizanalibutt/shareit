            ...
            try {
                getWifiManager().startLocalOnlyHotspot(new WifiManager.LocalOnlyHotspotCallback() {
                    ...
                    public void onStarted(WifiManager.LocalOnlyHotspotReservation reservation) {
                        ...
                        System.out.println("Wifi Hotspot is on now , reservation is : %s " + reservation.toString());
                        mHotspotReservation = reservation;
                        System.out.println("Wifi Hotspot is on now , reservation is : %s " + mHotspotReservation.toString());
                        if (mCallback != null)
