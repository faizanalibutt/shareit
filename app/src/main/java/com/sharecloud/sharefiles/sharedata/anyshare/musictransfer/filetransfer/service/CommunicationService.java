...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.CommunicationNotificationHelper;
...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.NsdDiscovery;
...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.UpdateUtils;
                        ...
                        if (device.isRestricted) {
                            ...
                            Log.d(TAG_LOCAL,
                                    "CommunicationServer.onConnected(): " + "Device Restricted Output "
                                            + shouldContinue + " Please Accept Connection Requested.");
                        }
                    }
...
//                                Callback.isTransferCompleted(true);
                            ...
                            processHolder.notification.cancel();
                            Log.d("Progress", "notification was cancelled");
