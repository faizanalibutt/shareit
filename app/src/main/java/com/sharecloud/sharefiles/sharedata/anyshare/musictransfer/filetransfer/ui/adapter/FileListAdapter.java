...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.object.FileShortcutObject;
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.object.WritablePathObject;
...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.MimeIconUtils;
...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.miscpkg.GroupShareable;
...
public class FileListAdapter
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister) {
        ...
        if (path != null) {
            ...
            {
                // TODO: 9/23/2019 file list adapter recent files code commented #10
    ...
    public static class GenericFileHolder extends GroupShareable {
