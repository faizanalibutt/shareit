...
public class NetworkDeviceLoader {
    ...
    public static void processConnection(AccessDatabase database, NetworkDevice device, NetworkDevice.Connection connection) {
        try {
            ...
            com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.AppUtils.applyAdapterName(connection);
        }
    ...
    public static NetworkDevice load(boolean currentThread, final AccessDatabase database, final String ipAddress, final OnDeviceRegisteredListener listener) throws ConnectException {
        com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.CommunicationBridge.Client.ConnectionHandler connectionHandler = new com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.CommunicationBridge.Client.ConnectionHandler() {
            @Override
            public void onConnect(com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.CommunicationBridge.Client client) {
                try {
        ...
        if (currentThread)
            return com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.CommunicationBridge.connect(database, NetworkDevice.class, connectionHandler);
        else
