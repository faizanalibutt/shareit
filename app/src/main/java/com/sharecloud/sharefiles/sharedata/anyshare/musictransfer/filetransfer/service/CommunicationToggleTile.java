...
public class CommunicationToggleTile extends TileService {
    ...
    public void onClick() {
        ...
        if (isMyServiceRunning(com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.service.CommunicationService.class))
            stopService(new Intent(getApplicationContext(), com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.service.CommunicationService.class));
        else
            AppUtils.startForegroundService(this, new Intent(getApplicationContext(), com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.service.CommunicationService.class));
