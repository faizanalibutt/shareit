...
public class FileUtils extends com.genonbeta.android.framework.util.FileUtils {
    ...
    public static DocumentFile getApplicationDirectory(Context context) {
        ...
        SharedPreferences defaultPreferences = com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.AppUtils.getDefaultPreferences(context);
     ...
     *
     * @param context //     * @param preferences
     * @param group
     * @return
     */
