...
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.callback.OnDeviceSelectedListener;
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.database.AccessDatabase;
import com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.dialog.ConnectionChooserDialog;
...
public class TransferUtils {
    ...
    public static TransferObject fetchFirstTransfer(Context context, long groupId,
        ...
        CursorItem receiverInstance = com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.AppUtils.getDatabase(context).getFirstFromTable(new SQLQuery
    ...
    public static void pauseTransfer(Context context, long groupId, @Nullable String deviceId) {
        ...
        com.sharecloud.sharefiles.sharedata.anyshare.musictransfer.filetransfer.util.AppUtils.startForegroundService(context, intent);
    }
    ...
    public static void requestStartSending(final Activity activity, final TransferGroup group,
        ...
        // TODO: 10/23/2019 Worker Service Transferutils commented #30
    ...
    public static void startTransferWithTest(final Activity activity, final TransferGroup group,
        ...
        // TODO: 10/23/2019 worker service transfer utils commented #31
    ...
    public static void startTransfer(final Activity activity, final TransferGroup group,
        ...
        if (activity != null && !activity.isFinishing())
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    // TODO: 10/23/2019 transfer utils transfer start commented #32
                    /*try {
