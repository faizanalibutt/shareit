...
public class MimeIconUtils {
    ...
    static {
        int icon;
        // Package
        icon = R.drawable.ic_android_white_icon_24db;
        add("application/vnd.android.package-archive", icon);
        // Audio
        icon = R.drawable.ic_music_box_white_icon_24dp;
        add("application/ogg", icon);
        add("application/x-flac", icon);
        // Certificate
        icon = R.drawable.ic_certificate_white_icon_24dp;
        ...
        // Compressed
        icon = R.drawable.ic_zip_white_icon_24dp;
        ...
        // PDF
        icon = R.drawable.ic_pdf_white_icon_24dp;
        add("application/pdf", icon);
        // Presentation
        icon = R.drawable.ic_presentation_whtie_icon_24dp;
        ...
        // Spreadsheet
        icon = R.drawable.ic_spreadsheet_whtie_icon_24dp;
        ...
        // Document
        icon = R.drawable.ic_document_white_icon_24dp;
        ...
        // Video
        icon = R.drawable.ic_videos_white_icon_24dp;
        add("application/x-quicktimeplayer", icon);
        add("application/x-shockwave-flash", icon);
        // Word
        icon = R.drawable.ic_word_white_icon_24dp;
        ...
        // Excel
        icon = R.drawable.ic_excel_white_icon_24dp;
        ...
        // Powerpoint
        icon = R.drawable.ic_powerpoint_icon_24db;
    ...
    public static int loadMimeIcon(String mimeType) {
        if (DocumentsContract.Document.MIME_TYPE_DIR.equals(mimeType))
            return R.drawable.ic_folder_white_icon_24dp;
        ...
        if (mimeType == null)
            return R.drawable.ic_drive_white_icon_24dp;

        final String typeOnly = mimeType.split("/")[0];

        if ("audio".equals(typeOnly)) {
            return R.drawable.ic_music_box_white_icon_24dp;
        } else if ("image".equals(typeOnly)) {
            return R.drawable.ic_image_white_icon_24dp;
        } else if ("text".equals(typeOnly)) {
            return R.drawable.ic_document_white_icon_24dp;
        } else if ("video".equals(typeOnly)) {
            return R.drawable.ic_videos_white_icon_24dp;
        } else {
            return R.drawable.ic_drive_white_icon_24dp;
        }
    }
